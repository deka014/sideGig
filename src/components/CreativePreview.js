...
const CreativePreview = ({
  ...
  const [selectedFrame, setSelectedFrame] = useState(frame1); // Default frame
      ...
      <div className="row justify-content-center mb-5">
        <div className="col-12 col-lg-6 text-center">
          ...
          <div className="d-flex justify-content-between">
            <button
              className={`btn btn-outline-primary ${selectedFrame === frame1 ? 'active' : ''}`}
              onClick={() => setSelectedFrame(frame1)}
            >
              Frame 1
            </button>
            <button
              className={`btn btn-outline-success ${selectedFrame === frame2 ? 'active' : ''}`}
              onClick={() => setSelectedFrame(frame2)}
            >
              Frame 2
            </button>
            <button
              className={`btn btn-outline-danger ${selectedFrame === frame3 ? 'active' : ''}`}
