    ...
    <div className="container py-5">
      <div className="row align-items-center">
        ...
        <div className="col-lg-6 text-center text-lg-start mb-4 mb-lg-0">
          <img
            src="https://shine.creativemox.com/sociabiz/wp-content/uploads/sites/16/2024/08/Team.png" // Replace with actual image URL
            alt="Illustration"
          ...
          <div className="d-flex mb-3">
            ...
            <div>
              ...
              <p className="text-muted mb-0">
                Netus urna tempor ornare ad risus malesuada venenatis dolor porttitor mauris tortor risus malesuada venenatis dolor porttitor mauris 
              </p>
            </div>
          </div>
      ...
      <div className="text-center mt-5">
        ...
        <div className="d-flex justify-content-center flex-wrap">
          <img
            src="https://shine.creativemox.com/sociabiz/wp-content/uploads/sites/16/2024/08/logo-1.png" // Replace with actual logo URLs
            alt="Brand Logo"
            className="mx-3 my-2"
          />
          <img
